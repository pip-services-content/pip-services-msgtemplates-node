...
import { MessageTemplatesCouchbasePersistence } from '../persistence/MessageTemplatesCouchbasePersistence';
...
export class MessageTemplatesServiceFactory extends Factory {
	...
	public static CouchbasePersistenceDescriptor = new Descriptor("pip-services-msgtemplates", "persistence", "couchbase", "*", "1.0");
	...
	constructor() {
		...
		this.registerAsType(MessageTemplatesServiceFactory.CouchbasePersistenceDescriptor, MessageTemplatesCouchbasePersistence);
