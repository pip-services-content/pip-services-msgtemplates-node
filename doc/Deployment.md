...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-msgtemplates-node": "^1.1.*",
        ...
    }
}
```
...
var plugin = new require('pip-services-msgtemplates-node').MessageTemplatesSenecaPlugin;
...
or by using [MessageTemplatesSenecaClient](https://github.com/pip-services-content/pip-clients-msgtemplates-node/doc/NodeClientApiV1.md/#client_seneca)