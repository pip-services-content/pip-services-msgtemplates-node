...
class MessageTemplatesCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetMessageTemplateByIdOrNameCommand() {
        return new pip_services3_commons_node_2.Command("get_template_by_id_or_name", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty('id_or_name', pip_services3_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
