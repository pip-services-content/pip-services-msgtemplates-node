...
class MessageTemplatesServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
MessageTemplatesServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("pip-services-msgtemplates", "factory", "default", "default", "1.0");
MessageTemplatesServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-msgtemplates", "persistence", "memory", "*", "1.0");
MessageTemplatesServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-msgtemplates", "persistence", "file", "*", "1.0");
MessageTemplatesServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-msgtemplates", "persistence", "mongodb", "*", "1.0");
MessageTemplatesServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-msgtemplates", "controller", "default", "*", "1.0");
MessageTemplatesServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-msgtemplates", "service", "seneca", "*", "1.0");
MessageTemplatesServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("pip-services-msgtemplates", "service", "http", "*", "1.0");
