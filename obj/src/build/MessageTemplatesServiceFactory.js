...
const MessageTemplatesCouchbasePersistence_1 = require("../persistence/MessageTemplatesCouchbasePersistence");
...
class MessageTemplatesServiceFactory extends pip_services3_components_node_1.Factory {
    constructor() {
        ...
        this.registerAsType(MessageTemplatesServiceFactory.CouchbasePersistenceDescriptor, MessageTemplatesCouchbasePersistence_1.MessageTemplatesCouchbasePersistence);
...
MessageTemplatesServiceFactory.CouchbasePersistenceDescriptor = new pip_services3_commons_node_1.Descriptor("pip-services-msgtemplates", "persistence", "couchbase", "*", "1.0");
